...
bns_fc4_features = 'brocade-name-server/fibrechannel-name-server/fc4-features'
bns_node_symbol = 'brocade-name-server/fibrechannel-name-server/node-symbolic-name'
bns_port_symbol = 'brocade-name-server/fibrechannel-name-server/port-symbolic-name'
bns_share_area = 'brocade-name-server/fibrechannel-name-server/share-area'
bns_redirection = 'brocade-name-server/fibrechannel-name-server/frame-redirection'
bns_partial = 'brocade-name-server/fibrechannel-name-server/partial'
bns_lsan = 'brocade-name-server/fibrechannel-name-server/lsan'
bns_cascade_ag = 'brocade-name-server/fibrechannel-name-server/cascaded-ag'
bns_connect_ag = 'brocade-name-server/fibrechannel-name-server/connected-through-ag'
bns_dev_behind_ag = 'brocade-name-server/fibrechannel-name-server/real-device-behind-ag'
bns_fcoe_dev = 'brocade-name-server/fibrechannel-name-server/fcoe-device'
bns_sddq = 'brocade-name-server/fibrechannel-name-server/slow-drain-device-quarantine'
bns_port_id = 'brocade-name-server/fibrechannel-name-server/port-id'
bns_port_name = 'brocade-name-server/fibrechannel-name-server/port-name'
bns_link_speed = 'brocade-name-server/fibrechannel-name-server/link-speed'
bns_ns_dev_type = 'brocade-name-server/fibrechannel-name-server/name-server-device-type'
bns_node_name = 'brocade-name-server/fibrechannel-name-server/node-name'
bns_scr = 'brocade-name-server/fibrechannel-name-server/state-change-registration'
bns_fab_port_name = 'brocade-name-server/fibrechannel-name-server/fabric-port-name'
bns_perm_port_name = 'brocade-name-server/fibrechannel-name-server/permanent-port-name'
bns_port_index = 'brocade-name-server/fibrechannel-name-server/port-index'
# Commonly used URIs: brocade-fibrechannel-switch
bfs_uri = 'brocade-fibrechannel-switch/fibrechannel-switch'
bfs_name = 'brocade-fibrechannel-switch/fibrechannel-switch/name'
bfs_did = 'brocade-fibrechannel-switch/fibrechannel-switch/domain-id'
bfs_fcid_hex = 'brocade-fibrechannel-switch/fibrechannel-switch/fcid-hex'
bfs_principal = 'brocade-fibrechannel-switch/fibrechannel-switch/principal'
bfs_op_status = 'brocade-fibrechannel-switch/fibrechannel-switch/operational-status'
bfs_fab_user_name = 'brocade-fibrechannel-switch/fibrechannel-switch/fabric-user-friendly-name'
bfs_sw_user_name = 'brocade-fibrechannel-switch/fibrechannel-switch/user-friendly-name'
bfs_banner = 'brocade-fibrechannel-switch/fibrechannel-switch/banner'
bfs_fw_version ='brocade-fibrechannel-switch/fibrechannel-switch/firmware-version'
bfs_adv_tunning = 'brocade-fibrechannel-switch/fibrechannel-switch/advanced-performance-tuning-policy'
bfs_dls = 'brocade-fibrechannel-switch/fibrechannel-switch/dynamic-load-sharing'
bfs_domain_name = 'brocade-fibrechannel-switch/fibrechannel-switch/domain-name'
bfs_model = 'brocade-fibrechannel-switch/fibrechannel-switch/model'
bfs_vf_id = 'brocade-fibrechannel-switch/fibrechannel-switch/vf-id'
bfs_ag_mode = 'brocade-fibrechannel-switch/fibrechannel-switch/ag-mode'
bfs_enabled_state = 'brocade-fibrechannel-switch/fibrechannel-switch/is-enabled-state'
bfs_edge_hold = 'brocade-fibrechannel-configuration/switch-configuration/edge-hold-time'

# Commonly used URIs: brocade-fibrechannel-configuration
bfc_uri = 'brocade-fibrechannel-configuration/fabric'
bfc_idid = 'brocade-fibrechannel-configuration/fabric/insistent-domain-id-enabled'
bfc_fport_enforce_login = 'brocade-fibrechannel-configuration/f-port-login-settings/enforce-login'
bfc_principal_en = 'brocade-fibrechannel-configuration/fabric/principal-selection-enabled'
bfc_principal_pri = 'brocade-fibrechannel-configuration/fabric/principal-priority'
bfc_xisl_en = 'brocade-fibrechannel-configuration/switch-configuration/xisl-enabled'
bfc_portname_mode = 'brocade-fibrechannel-configuration/port-configuration/portname-mode'
bfc_portname_format = 'brocade-fibrechannel-configuration/port-configuration/dynamic-portname-format'
bfc_area_mode = 'brocade-fibrechannel-configuration/switch-configuration/area-mode'
bfc_up_time = 'brocade-fibrechannel-switch/fibrechannel-switch/up-time'
...
bfc_port_id_mode = 'brocade-fibrechannel-configuration/switch-configuration/wwn-port-id-mode'
# Commonly used URIs: brocade-fru
fru_uri = 'brocade-fru'
fru_blade = 'brocade-fru/blade'
fru_fan = 'brocade-fru/fan'
fru_ps = 'brocade-fru/power-supply'
fru_sensor = 'brocade-fru/sensor'
fru_wwn = 'brocade-fru/wwn'
fru_blade_pn = 'brocade-fru/blade/part-number'
...
ficon_cup_en = 'brocade-ficon/cup/fmsmode-enabled'
ficon_posc = 'brocade-ficon/cup/programmed-offline-state-control'
ficon_uam = 'brocade-ficon/cup/user-alert-mode'
ficon_asm = 'brocade-ficon/cup/active-equal-saved-mode'
ficon_dcam = 'brocade-ficon/cup/director-clock-alert-mode'
ficon_mihpto = 'brocade-ficon/cup/mihpto'
ficon_uam_fru = 'brocade-ficon/cup/unsolicited-alert-mode-fru-enabled'
ficon_uam_hsc = 'brocade-ficon/cup/unsolicited-alert-mode-hsc-enabled'
ficon_uam_invalid_attach = 'brocade-ficon/cup/unsolicited-alert-mode-invalid-attach-enabled'
